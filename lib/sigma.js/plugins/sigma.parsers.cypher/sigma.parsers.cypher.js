;(function (undefined) {
     ...
     * @param   {string}            method      The calling method for the endpointTemplate : 'GET' or 'POST'
    ...
    sigma.neo4j.send = function(neo4j, endpoint, method, data, callback) {
        ...
        // Construct the endpointTemplate url
    ...
    sigma.neo4j.cypher = function (neo4j, cypher, sig, callback) {
        ...
        // Let's call neo4j
        sigma.neo4j.send(neo4j, endpointTemplate, 'POST', data, cypherCallback(callback));
    };
